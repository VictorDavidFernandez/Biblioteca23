...
public class LibroController implements Serializable {
    ...
    private List<Libro> listaLibrosPremio;
    private List<Libro> listaLibrosPremiados;

    public List<Libro> getListaLibrosPremiados() {
        return listaLibrosPremiados;
    }

    public void setListaLibrosPremiados(List<Libro> listaLibrosPremiados) {
        this.listaLibrosPremiados = listaLibrosPremiados;
    }
    ...
    public List<Libro> getListaLibrosPremio() {
        return listaLibrosPremio;
    }

    public void setListaLibrosPremio(List<Libro> listaLibrosPremio) {
        this.listaLibrosPremio = listaLibrosPremio;
    }
    ...
    public void cargarLibros(){
        listaLibros = ejbFacade.librosAutor(autor);
    }

    public void cargarLibrosPremio(){
        listaLibrosPremio = ejbFacade.librosPremio(premio);
    }
    
    public void cargarLibrosPremiados(){
        listaLibrosPremiados = ejbFacade.librosPremiadosAutor(autor);
    }
}
