...
public class PremioController implements Serializable {
    ...
    public SelectItem[] getItemsAvailableSelectOne() {
        return getSelectItems(ejbFacade.premiosOrdenados(), true);
    }
    
    public SelectItem[] getItemsAvailableSelectBook() {
        return getSelectItems(ejbFacade.premios_libro(), true);
    }
    
        public SelectItem[] getItemsAvailableSelectAuthor() {
    ...
    public static class PremioControllerConverter implements Converter {
        ...
        public static SelectItem[] getSelectItems(List<Premio> entities, boolean selectOne) {
            ...
            int i = 0;
            if (selectOne) {
                items[0] = new SelectItem("-1", "Selecciona premios");
                i++;
            }
    ...
    public void cargarPremios(){
        listaPremios = ejbFacade.premiosDeAutor(autor);
    }
    
    public void listaLibrosPremiados(){
