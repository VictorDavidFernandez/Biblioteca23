...
public class AutorController implements Serializable {
    ...
    private List<AutorPremio>listaAutorPremio;
    private Pais pais;
    private Autor autor;
    private List<Autor>listaAutoresPais;
    private SelectItem[] selectItemAutores;
    ...
    public SelectItem[] getSelectItemAutores() {
        return selectItemAutores;
    }

    public void setSelectItemAutores(SelectItem[] selectItemAutores) {
        this.selectItemAutores = selectItemAutores;
    }

    public List<Autor> getListaAutoresPais() {
        return listaAutoresPais;
    }

    public void setListaAutoresPais(List<Autor> listaAutoresPais) {
        this.listaAutoresPais = listaAutoresPais;
    }
    ...
    public List<AutorPremio> getListaAutorPremio() {
        return listaAutorPremio;
    }

    public void setListaAutorPremio(List<AutorPremio> listaAutorPremio) {
        this.listaAutorPremio = listaAutorPremio;
    }
    ...
    public void getItemsAvailableSelectAutor() {
        if(premio != null)
            autores = getSelectItems(ejbFacade.autoresPorPremio(premio), true);
        autores = null;
    }

    public void loadSeleccionAutores() {
        if(pais != null){
            selectItemAutores = getSelectItems(ejbFacade.cargarAutoresPais(pais), true);
        }
        selectItemAutores = null;
    }    
    ...
    public static SelectItem[] getSelectItems(List<Autor> entities, boolean selectOne) {
        ...
        int i = 0;
        if (selectOne) {
            items[0] = new SelectItem("-1", "Selecciona un autor");
            i++;
        }
    ...
    public int calcularEdad(Date fechaNac){
        ...
        int anos = fechaActual.get(Calendar.YEAR) - fechaNacimiento.get(Calendar.YEAR);
    ...
    public void cargarAutoresPremio(){
        listaAutorPremio = ejbFacade.autoresPremios(premio);
    }
    
    public void cargarAutoresPais(){
        listaAutoresPais = ejbFacade.cargarAutoresPais(pais);
    }
}
